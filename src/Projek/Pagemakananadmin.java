...
public class Pagemakananadmin extends JFrame {
    ...
    private void updateQuantityInDatabase(String type, String brand, String expiredDate, double currentQuantity,
        ...
        String tempFilePath = "Database/TempDatafood.txt";
    ...
    public Pagemakananadmin() {
        ...
        JLabel lblNewLabel_1 = new JLabel("Current Food Stock");
        ...
        lblNewLabel_2.setIcon(new ImageIcon("F:\\TugasBinus\\semester 3\\OopPkm\\Img\\food1.jpg"));
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            Pagemakananadmin window = new Pagemakananadmin();
