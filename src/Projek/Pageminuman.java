...
public class Pageminuman extends JFrame {
    ...
    public Pageminuman() {
        ...
        JLabel lblNewLabel_1 = new JLabel("Selamat Berbelanja Minuman Favoritmu");
    ...
    private void addToCart() {
        ...
        try (BufferedReader reader = new BufferedReader(new FileReader("Database/Datadrink.txt"))) {
            ...
            try (BufferedWriter writer = new BufferedWriter(new FileWriter("Database/Datadrink.txt"))) {
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            Pageminuman window = new Pageminuman();
